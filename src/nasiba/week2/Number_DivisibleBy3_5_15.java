...
public class Number_DivisibleBy3_5_15 {
    ...
    public static void divider(int num){
        String divisibelBy5 ="",divisibelBy3="",divisibelBy15="";
        for (int i = 1; i <= num; i++) {
            if (i % 15 == 0) {
                divisibelBy15 += i + " ";
            } else if (i % 5 == 0) {
            ...
            System.out.println("DivisibleBy 15: "+divisibelBy15);
            System.out.println("DivisibleBy 5: "+divisibelBy5);
            System.out.println("DivisibleBy 3: "+divisibelBy3);
        }
    }
